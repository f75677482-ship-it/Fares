...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "بعد اكتمال الربط ستعمل جميع أوامر واتساب على الرقم المرتبط، وتظهر داخل أمر القائمة تلقائياً بعد إعادة التشغيل.\n"
